...
class DatabaseSeeder extends Seeder
{
    ...
    {
        /* Маршруты */
//        Trip::factory(1)->create(['num' => '1', 'from' => 'Урай', 'to' => 'Устье-Аха', 'from_time' => '05:00', 'to_time' => '07:30', 'duration' => '2ч 30м',  'from_desc' => 'сбор по остановкам', 'price' => '500']);
//        Trip::factory(1)->create(['num' => '2','from' => 'Урай', 'to' => 'Устье-Аха', 'from_time' => '14:30', 'to_time' => '17:00', 'duration' => '2ч 30м', 'price' => '500']);
//        Trip::factory(1)->create(['num' => '3','from' => 'Устье-Аха', 'to' => 'Урай', 'from_time' => '11:50', 'to_time' => '13:30', 'duration' => '1ч 40м', 'price' => '500']);
//        Trip::factory(1)->create(['num' => '4','from' => 'Устье-Аха', 'to' => 'Урай', 'from_time' => '23:00', 'to_time' => '01:30', 'duration' => '2ч 30м', 'change_date' => '1', 'price' => '500']);
...
//
//        User::factory(1)->create(['name' => 'TK999', 'email' => 'admin@adm.ru', 'password' => '$2y$10$Q6LMrwwXfKtSZt7g.a4QSOZ/3jBPARVCW9a40T1l57kwZlur6.ECi']);
        User::factory(1)->create(['name' => 'agent', 'email' => 'agent@adm.ru', 'password' => '$2y$10$Q6LMrwwXfKtSZt7g.a4QSOZ/3jBPARVCW9a40T1l57kwZlur6.ECi']);
        //Roles::factory(1)->create(['name' => 'agent', 'email' => 'admin@adm.ru', 'password' => '$2y$10$Q6LMrwwXfKtSZt7g.a4QSOZ/3jBPARVCW9a40T1l57kwZlur6.ECi']);
